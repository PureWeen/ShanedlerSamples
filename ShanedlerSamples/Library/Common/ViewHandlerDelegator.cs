...
#else
			_viewHandler.GetDesiredSize(widthConstraint, heightConstraint, minimumSize);
#endif
...
#else
			view.SetVirtualView(_viewHandler, onElementChanged, ref _element, ref _mapper, _defaultMapper, autoPackage);
#endif
		}
